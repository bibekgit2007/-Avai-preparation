...
physics_questions = [
    ...
    },
    {
        ...
        "opts": {'en': ['ε₀ (dΦ_E / dt)', 'μ₀ (dΦ_E / dt)', '(1/ε₀) (dΦ_E / dt)', 'ε₀ μ₀ (dΦ_E / dt)'], 'bn': ['ε₀ (dΦ_E / dt)', 'μ₀ (dΦ_E / dt)', '(1/ε₀) (dΦ_E / dt)', 'ε₀ μ₀ (dΦ_E / dt)']},
        "correct": 0,
    ...
    },
    {
        ...
        "opts": {'en': ['B_V = B_H', 'B_V = √3 B_H', 'B_V = B_H / √3', 'B_V = 0'], 'bn': ['B_V = B_H', 'B_V = √3 B_H', 'B_V = B_H / √3', 'B_V = 0']},
        "correct": 0,
