// Comprehensive Master Question Bank for AVAI Prep
window.PHYSICS_QUESTIONS_DATA = [
  ...
  },
  {
    ...
    "opts": {
      "en": ["400 units", "500 units", "3 × 10⁸ units", "3 × 10¹⁰ units"],
      "bn": ["400 units", "500 units", "3 × 10⁸ units", "3 × 10¹⁰ units"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["10 μF", "5 μF", "2.5 μF", "20 μF"],
      "bn": ["10 μF", "5 μF", "2.5 μF", "20 μF"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["+1.10 V", "-1.10 V", "+0.42 V", "-0.42 V"],
      "bn": ["+1.10 V", "-1.10 V", "+0.42 V", "-0.42 V"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Ethanol (CH₃CH₂OH)", "Methanol (CH₃OH)", "Benzophenone (C₆H₅COC₆H₅)", "Diethyl ether (C₂H₅OC₂H₅)"],
      "bn": ["ইথানল (CH₃CH₂OH)", "মিথানল (CH₃OH)", "বেনজোফেনন", "ডাইইথাইল ইথার"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["d²sp³, Paramagnetic (1 unpaired electron)", "sp³d², Paramagnetic (5 unpaired electrons)", "d²sp³, Diamagnetic", "sp³d², Diamagnetic"],
      "bn": ["d²sp³, পরাচৌম্বকীয় (১টি বিজোড় ইলেকট্রন)", "sp³d², পরাচৌম্বকীয় (৫টি বিজোড় ইলেকট্রন)", "d²sp³, তিরশ্চৌম্বকীয়", "sp³d², তিরশ্চৌম্বকীয়"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Mitochondria", "Golgi Apparatus", "Lysosome", "Peroxisome"],
      "bn": ["মাইটোকনড্রিয়া", "গলগি বডি", "লাইসোজোম", "পারঅক্সিজোম"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Fall in Glomerular Blood Pressure / GFR", "Rise in Blood Pressure", "High blood sodium level", "Atrial Natriuretic Peptide release"],
      "bn": ["গ্লোমেরুলার রক্তচাপ / GFR হ্রাস পেলে", "রক্তচাপ বৃদ্ধি পেলে", "রক্তে উচ্চ সোডিয়াম মাত্রা", "ANP ক্ষরণ হলে"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["(1/2) tan⁻¹(x/2) + C", "tan⁻¹(x/2) + C", "(1/4) tan⁻¹(x/4) + C", "ln(x² + 4) + C"],
      "bn": ["(1/2) tan⁻¹(x/2) + C", "tan⁻¹(x/2) + C", "(1/4) tan⁻¹(x/4) + C", "ln(x² + 4) + C"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Kathmandu, Nepal", "New Delhi, India", "Dhaka, Bangladesh", "Colombo, Sri Lanka"],
      "bn": ["কাঠমান্ডু, নেপাল", "নয়াদিল্লি, ভারত", "ঢাকা, বাংলাদেশ", "কলম্বো, শ্রীলঙ্কা"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Rabindranath Tagore (1913)", "C. V. Raman (1930)", "Mother Teresa (1979)", "Amartya Sen (1998)"],
      "bn": ["রবীন্দ্রনাথ ঠাকুর (১৯১৩)", "সি. ভি. রমন (১৯৩০)", "মাদার তেরেসা (১৯৭৯)", "অমর্ত্য সেন (১৯৯৮)"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "topic": "Optics & Physics in Daily Life",
    "difficulty": "Easy",
    "year": "2024",
    ...
    "opts": {
      "en": ["Total Internal Reflection (TIR)", "Refraction only", "Scattering of light", "Diffraction"],
      "bn": ["অভ্যন্তরীণ পূর্ণ প্রতিফলন (TIR)", "কেবল প্রতিসরণ", "আলোর বিচ্ছুরণ", "অপবর্তন"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Resolution of 'Poorna Swaraj' (Complete Independence) was passed", "Non-Cooperation Movement was launched", "Quit India Resolution was adopted", "Gandhi-Irwin Pact was signed"],
      "bn": ["'পূর্ণ স্বরাজ' প্রস্তাব গৃহীত হয়", "অসহযোগ আন্দোলন শুরু হয়", "ভারত ছাড়ো প্রস্তাব গৃহীত হয়", "গান্ধী-আরউইন চুক্তি স্বাক্ষরিত হয়"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Andaman Islands and Nicobar Islands", "Lakshadweep and Maldives", "South Andaman and Little Andaman", "Minicoy and Maldives"],
      "bn": ["আন্দামান এবং নিকোবর দ্বীপপুঞ্জ", "লাক্ষাদ্বীপ এবং মালদ্বীপ", "দক্ষিণ আন্দামান এবং লিটল আন্দামান", "মিনিকয় এবং মালদ্বীপ"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["Article 32 (Right to Constitutional Remedies)", "Article 21 (Right to Life)", "Article 14 (Equality before Law)", "Article 19 (Freedom of Speech)"],
      "bn": ["অনুচ্ছেদ ৩২ (সাংবিধানিক প্রতিকারের অধিকার)", "অনুচ্ছেদ ২১ (জীবনের অধিকার)", "অনুচ্ছেদ ১৪ (আইনের দৃষ্টিতে সমতা)", "অনুচ্ছেদ ১৯ (বাকস্বাধীনতা)"]
    },
    "correct": 0,
  ...
  },
  {
    ...
    "opts": {
      "en": ["were", "was", "is", "has been"],
      "bn": ["were", "was", "is", "has been"]
    },
    "correct": 0,
